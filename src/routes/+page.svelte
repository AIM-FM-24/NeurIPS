...
<section class="bg-white dark:bg-gray-900" style="background-image: url('background.jpg'); background-size: cover; background-position: center;">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
		...
		<h3 class="text-white">
		<i class="fas fa-star"></i> Co-located with NeurIPS 2024	
		</h3>
		<h3 class="font-extrabold tracking-tight leading-none text-white tracking-wider">
		<i class="fas fa-calendar"></i> December 14, 2024	
		</h3>
		<h3 class="mb-4 font-extrabold tracking-tight leading-none text-white tracking-wider">
